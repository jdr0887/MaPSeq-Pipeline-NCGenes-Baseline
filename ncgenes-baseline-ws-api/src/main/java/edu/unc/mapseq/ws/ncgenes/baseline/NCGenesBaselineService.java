...
@WebService(targetNamespace = "http://baseline.ncgenes.ws.mapseq.unc.edu", serviceName = "NCGenesBaselineService", portName = "NCGenesBaselinePort")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.WRAPPED)
@Path("/NCGenesBaselineService/")
