package edu.unc.mapseq.ws.ncgenes.impl;
...
import edu.unc.mapseq.ws.ncgenes.NCGenesService;
import edu.unc.mapseq.ws.ncgenes.QualityControlInfo;

public class NCGenesServiceImpl implements NCGenesService {

    private final Logger logger = LoggerFactory.getLogger(NCGenesServiceImpl.class);
