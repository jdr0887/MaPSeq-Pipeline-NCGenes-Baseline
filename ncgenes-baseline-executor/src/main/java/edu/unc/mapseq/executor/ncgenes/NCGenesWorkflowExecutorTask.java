package edu.unc.mapseq.executor.ncgenes;
...
import edu.unc.mapseq.workflow.ncgenes.NCGenesWorkflow;

public class NCGenesWorkflowExecutorTask extends TimerTask {

    private final Logger logger = LoggerFactory.getLogger(NCGenesWorkflowExecutorTask.class);

    private final WorkflowTPE threadPoolExecutor = new WorkflowTPE();

    private WorkflowBeanService workflowBeanService;

    public NCGenesWorkflowExecutorTask() {
        super();
    }
    ...
    public void run() {
        ...
        try {
            ...
            if (workflowList == null || (workflowList != null && workflowList.isEmpty())) {
                logger.error("No Workflow Found: {}", "NCGenes");
                return;
            }
            ...
            if (attempts != null && !attempts.isEmpty()) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCGenesWorkflow ncGenesWorkflow = new NCGenesWorkflow();
