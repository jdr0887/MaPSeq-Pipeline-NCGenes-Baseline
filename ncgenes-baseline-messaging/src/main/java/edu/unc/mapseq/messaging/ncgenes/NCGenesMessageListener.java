...
public class NCGenesMessageListener extends AbstractSampleMessageListener {

    private final Logger logger = LoggerFactory.getLogger(NCGenesMessageListener.class);

    public NCGenesMessageListener() {
        super();
    }
